		...
		<div class="container-fluid">
			<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
				<li class="nav-item dropdown">
					<a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false"> <img src="<?php _url('assets/img/user.png');?>" alt="user-img" width="36" class="img-circle"><span ><?php echo $user['first_name'].' '.$user['last_name']; ?></span>
					</a>
